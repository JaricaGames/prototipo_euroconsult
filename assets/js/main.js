...
(function () {
  ...
  var dicts = {
    es: {
      ...
      meta_desc: "EC Proyectos de Ingeniería nace en 2024 para dar continuidad a dos de las empresas más emblemáticas de Grupo Euroconsult. Más de 50 años de experiencia, con sedes en España, Perú y Colombia.",
      // Descripción por página: cada una la declara con <body data-desc-key="...">.
      // El index no lleva atributo y usa meta_desc.
      d_areas: "Áreas de negocio de EC Proyectos de Ingeniería: transportes, aeropuertos, puertos y costas, aguas y edificación.",
      d_contacto: "Contacto institucional de EC Proyectos de Ingeniería: consultas institucionales, alianzas y relaciones con inversores.",
      d_grupo: "EC Proyectos de Ingeniería: experiencia que permanece, ingeniería que evoluciona. Historia, continuidad y renovación, misión y visión.",
      d_hablemos: "Cuéntanos tu proyecto y lo revisará el equipo técnico de EC Proyectos de Ingeniería: alcance, fase y plazos, para responderte con una primera valoración.",
      d_legal: "Aviso legal, política de privacidad y política de cookies del sitio web de EC Proyectos de Ingeniería.",
      d_presencia: "Presencia internacional de EC Proyectos de Ingeniería: Madrid, Lima y Bogotá. Un grupo, tres sedes, dos continentes.",
      d_proyecto: "Detalle de proyecto de EC Proyectos de Ingeniería: el reto, la solución y el impacto.",
      d_proyectos: "Proyectos de EC Proyectos de Ingeniería: cada obra explica el reto, la solución y el impacto.",
      d_trabaja: "Trabaja con EC Proyectos de Ingeniería: buscamos ingenieros y técnicos que entiendan la precisión como una forma de respeto. Envíanos tu candidatura.",
      ...
      p1_kicker: "Proyecto destacado / Infraestructura vial",
      p1_t: "Mejoramiento de la carretera Huallanca – Caraz",
      p1_alt: "Túnel excavado en roca en la carretera Huallanca – Caraz",
      lbl_ubi: "Ubicación", lbl_sector: "Sector", lbl_tipo: "Tipología", lbl_cliente: "Cliente", lbl_monto: "Importe",
      p1_ubi: "Áncash (Perú)", p1_sector: "Transporte", p1_tipo: "Carreteras",
      ...
      hero_title: "Una nueva etapa con más de <span class='hl'>50 años</span> de experiencia",
      hero_sub: "Desde 2024, ECPI da continuidad a la trayectoria de <span class='hl-b'>Grupo Euroconsult</span> integrando dos de sus empresas más emblemáticas.",
      ...
      s1_p3: "En 2024 comienza una nueva etapa. La adquisición de dos de las empresas más emblemáticas de Euroconsult permite preservar y potenciar ese conocimiento dentro de una compañía renovada, creada con una clara orientación hacia la innovación, la excelencia técnica y el servicio al cliente.",
      mis_t: "Misión",
      ...
      s3_p: "Cada sede conserva su identidad regional bajo el respaldo común de EC Proyectos de Ingeniería.",
      ...
      sg_title: "Una nueva etapa en una trayectoria de más de 50 años",
      sg_p1: "EC Proyectos de Ingeniería inicia en 2024 una nueva etapa empresarial que da continuidad a la experiencia, el conocimiento y las capacidades desarrolladas durante décadas por Grupo Euroconsult, compañía histórica de la ingeniería española fundada en 1968.",
      sg_p2: "ECPI ha integrado en su proyecto dos de las empresas más emblemáticas de Euroconsult, preservando su actividad, sus equipos profesionales y su conocimiento técnico. Sobre esta sólida base, construimos una organización más ágil, eficiente y preparada para afrontar los nuevos retos de la ingeniería.",
      pp_title: "Nuestro punto de partida",
      pp1_t: "+50 años de trayectoria",
      pp1_p: "Una experiencia y un conocimiento técnico construidos durante más de cinco décadas de actividad en el sector de la ingeniería.",
      pp2_t: "2 empresas emblemáticas",
      pp2_p: "Dos compañías de referencia de Euroconsult integradas en ECPI para asegurar la continuidad de su actividad, capacidades y experiencia.",
      pp3_t: "Un equipo especializado",
      pp3_p: "Profesionales con amplia experiencia y un profundo conocimiento técnico en sus respectivas áreas de actividad.",
      pp4_t: "Una nueva visión",
      pp4_p: "La experiencia y la solidez de una trayectoria histórica, unidas a una organización moderna, flexible y orientada al futuro.",
      hito4_t: "2024 — Nueva etapa",
      hito4_p: "La adquisición de dos de las empresas más emblemáticas de Euroconsult da origen a EC Proyectos de Ingeniería.",
    ...
    en: {
      ...
      meta_desc: "EC Proyectos de Ingeniería was founded in 2024 to carry forward two of the most emblematic companies of Grupo Euroconsult. More than 50 years of experience, with offices in Spain, Peru and Colombia.",
      // Descripción por página. Traducción automática desde el español:
      // conviene que la revise un traductor.
      d_areas: "Business areas of EC Proyectos de Ingeniería: transport, airports, ports and coasts, water and building.",
      d_contacto: "Corporate contact for EC Proyectos de Ingeniería: institutional enquiries, partnerships and investor relations.",
      d_grupo: "EC Proyectos de Ingeniería: experience that endures, engineering that evolves. History, continuity and renewal, mission and vision.",
      d_hablemos: "Tell us about your project and the technical team at EC Proyectos de Ingeniería will review it: scope, stage and timescales, so we can come back with a first assessment.",
      d_legal: "Legal notice, privacy policy and cookie policy for the EC Proyectos de Ingeniería website.",
      d_presencia: "International presence of EC Proyectos de Ingeniería: Madrid, Lima and Bogotá. One group, three offices, two continents.",
      d_proyecto: "Project detail from EC Proyectos de Ingeniería: the challenge, the solution and the impact.",
      d_proyectos: "Projects by EC Proyectos de Ingeniería: every work explains the challenge, the solution and the impact.",
      d_trabaja: "Work with EC Proyectos de Ingeniería: we look for engineers and technicians who understand precision as a form of respect. Send us your application.",
      ...
      p1_kicker: "Featured project / Road infrastructure",
      p1_t: "Upgrade of the Huallanca – Caraz road",
      p1_alt: "Rock tunnel on the Huallanca – Caraz road",
      lbl_ubi: "Location", lbl_sector: "Sector", lbl_tipo: "Typology", lbl_cliente: "Client", lbl_monto: "Contract value",
      p1_ubi: "Áncash (Peru)", p1_sector: "Transport", p1_tipo: "Roads",
      ...
      hero_kicker: "EC Proyectos de Ingeniería",
      hero_title: "A new chapter with more than <span class='hl'>50 years</span> of experience",
      hero_sub: "Since 2024, ECPI has carried forward the legacy of <span class='hl-b'>Grupo Euroconsult</span>, bringing together two of its most emblematic companies.",
      ...
      s1_p3: "A new chapter begins in 2024. The acquisition of two of Euroconsult's most emblematic companies makes it possible to preserve and strengthen that knowledge within a renewed company, created with a clear focus on innovation, technical excellence and client service.",
      mis_t: "Mission",
      ...
      s3_p: "Each office keeps its regional identity under the shared endorsement of EC Proyectos de Ingeniería.",
      ...
      sg_title: "A new chapter in a track record of more than 50 years",
      sg_p1: "EC Proyectos de Ingeniería began a new corporate chapter in 2024, carrying forward the experience, the knowledge and the capabilities built up over decades by Grupo Euroconsult, a landmark firm in Spanish engineering founded in 1968.",
      sg_p2: "ECPI has brought two of Euroconsult's most emblematic companies into its project, preserving their activity, their professional teams and their technical expertise. On this solid foundation we are building a more agile and efficient organisation, ready to take on the new challenges of engineering.",
      pp_title: "Our starting point",
      pp1_t: "50+ years of track record",
      pp1_p: "Experience and technical expertise built over more than five decades of activity in the engineering sector.",
      pp2_t: "2 emblematic companies",
      pp2_p: "Two leading Euroconsult companies integrated into ECPI to secure the continuity of their activity, capabilities and experience.",
      pp3_t: "A specialised team",
      pp3_p: "Professionals with extensive experience and deep technical knowledge in their respective fields.",
      pp4_t: "A new outlook",
      pp4_p: "The experience and solidity of a historic track record, combined with a modern, flexible and forward-looking organisation.",
      hito4_t: "2024 — A new chapter",
      hito4_p: "The acquisition of two of Euroconsult's most emblematic companies gives rise to EC Proyectos de Ingeniería.",
    ...
    fr: {
      ...
      meta_desc: "EC Proyectos de Ingeniería naît en 2024 pour assurer la continuité de deux des entreprises les plus emblématiques du Grupo Euroconsult. Plus de 50 ans d'expérience, avec des implantations en Espagne, au Pérou et en Colombie.",
      // Descripción por página. Traducción automática desde el español:
      // conviene que la revise un traductor.
      d_areas: "Domaines d'activité d'EC Proyectos de Ingeniería : transports, aéroports, ports et littoral, eau et bâtiment.",
      d_contacto: "Contact institutionnel d'EC Proyectos de Ingeniería : demandes institutionnelles, partenariats et relations investisseurs.",
      d_grupo: "EC Proyectos de Ingeniería : une expérience qui demeure, une ingénierie qui évolue. Histoire, continuité et renouveau, mission et vision.",
      d_hablemos: "Présentez-nous votre projet et l'équipe technique d'EC Proyectos de Ingeniería l'étudiera : périmètre, phase et délais, pour vous répondre avec une première évaluation.",
      d_legal: "Mentions légales, politique de confidentialité et politique de cookies du site web d'EC Proyectos de Ingeniería.",
      d_presencia: "Présence internationale d'EC Proyectos de Ingeniería : Madrid, Lima et Bogotá. Un groupe, trois sièges, deux continents.",
      d_proyecto: "Détail de projet d'EC Proyectos de Ingeniería : le défi, la solution et l'impact.",
      d_proyectos: "Projets d'EC Proyectos de Ingeniería : chaque ouvrage explique le défi, la solution et l'impact.",
      d_trabaja: "Travaillez avec EC Proyectos de Ingeniería : nous recherchons des ingénieurs et des techniciens qui voient la précision comme une forme de respect. Envoyez-nous votre candidature.",
      ...
      p1_kicker: "Projet phare / Infrastructure routière",
      p1_t: "Amélioration de la route Huallanca – Caraz",
      p1_alt: "Tunnel creusé dans la roche sur la route Huallanca – Caraz",
      lbl_ubi: "Localisation", lbl_sector: "Secteur", lbl_tipo: "Typologie", lbl_cliente: "Client", lbl_monto: "Montant",
      p1_ubi: "Áncash (Pérou)", p1_sector: "Transport", p1_tipo: "Routes",
      ...
      hero_kicker: "EC Proyectos de Ingeniería",
      hero_title: "Une nouvelle étape avec plus de <span class='hl'>50 ans</span> d'expérience",
      hero_sub: "Depuis 2024, ECPI assure la continuité du parcours du <span class='hl-b'>Grupo Euroconsult</span> en intégrant deux de ses entreprises les plus emblématiques.",
      ...
      s1_p3: "En 2024 commence une nouvelle étape. L'acquisition de deux des entreprises les plus emblématiques d'Euroconsult permet de préserver et de renforcer ce savoir-faire au sein d'une société renouvelée, créée avec une orientation claire vers l'innovation, l'excellence technique et le service au client.",
      mis_t: "Mission",
      ...
      s3_p: "Chaque siège conserve son identité régionale sous la caution commune d'EC Proyectos de Ingeniería.",
      ...
      // Textos de la nueva etapa (2024). Las versiones EN/FR/PT las generó
      // Claude a partir del español: conviene que las revise un traductor.
      sg_title: "Une nouvelle étape dans un parcours de plus de 50 ans",
      sg_p1: "EC Proyectos de Ingeniería entame en 2024 une nouvelle étape entrepreneuriale qui assure la continuité de l'expérience, du savoir-faire et des capacités développés pendant des décennies par le Grupo Euroconsult, société historique de l'ingénierie espagnole fondée en 1968.",
      sg_p2: "ECPI a intégré à son projet deux des entreprises les plus emblématiques d'Euroconsult, en préservant leur activité, leurs équipes professionnelles et leur savoir-faire technique. Sur cette base solide, nous construisons une organisation plus agile, efficace et prête à relever les nouveaux défis de l'ingénierie.",
      pp_title: "Notre point de départ",
      pp1_t: "Plus de 50 ans de parcours",
      pp1_p: "Une expérience et un savoir-faire technique construits au fil de plus de cinq décennies d'activité dans le secteur de l'ingénierie.",
      pp2_t: "2 entreprises emblématiques",
      pp2_p: "Deux sociétés de référence d'Euroconsult intégrées à ECPI afin d'assurer la continuité de leur activité, de leurs capacités et de leur expérience.",
      pp3_t: "Une équipe spécialisée",
      pp3_p: "Des professionnels dotés d'une large expérience et d'une profonde maîtrise technique dans leurs domaines respectifs.",
      pp4_t: "Une vision nouvelle",
      pp4_p: "L'expérience et la solidité d'un parcours historique, alliées à une organisation moderne, souple et tournée vers l'avenir.",
      hito4_t: "2024 — Nouvelle étape",
      hito4_p: "L'acquisition de deux des entreprises les plus emblématiques d'Euroconsult donne naissance à EC Proyectos de Ingeniería.",
    ...
    pt: {
      ...
      meta_desc: "A EC Proyectos de Ingeniería nasce em 2024 para dar continuidade a duas das empresas mais emblemáticas do Grupo Euroconsult. Mais de 50 anos de experiência, com sedes em Espanha, Peru e Colômbia.",
      // Descripción por página. Traducción automática desde el español:
      // conviene que la revise un traductor.
      d_areas: "Áreas de negócio da EC Proyectos de Ingeniería: transportes, aeroportos, portos e costas, águas e edificação.",
      d_contacto: "Contacto institucional da EC Proyectos de Ingeniería: consultas institucionais, parcerias e relações com investidores.",
      d_grupo: "EC Proyectos de Ingeniería: experiência que permanece, engenharia que evolui. História, continuidade e renovação, missão e visão.",
      d_hablemos: "Conte-nos o seu projeto e a equipa técnica da EC Proyectos de Ingeniería vai analisá-lo: âmbito, fase e prazos, para lhe responder com uma primeira avaliação.",
      d_legal: "Aviso legal, política de privacidade e política de cookies do site da EC Proyectos de Ingeniería.",
      d_presencia: "Presença internacional da EC Proyectos de Ingeniería: Madrid, Lima e Bogotá. Um grupo, três sedes, dois continentes.",
      d_proyecto: "Detalhe de projeto da EC Proyectos de Ingeniería: o desafio, a solução e o impacto.",
      d_proyectos: "Projetos da EC Proyectos de Ingeniería: cada obra explica o desafio, a solução e o impacto.",
      d_trabaja: "Trabalhe com a EC Proyectos de Ingeniería: procuramos engenheiros e técnicos que entendam a precisão como uma forma de respeito. Envie-nos a sua candidatura.",
      ...
      p1_kicker: "Projeto em destaque / Infraestrutura rodoviária",
      p1_t: "Melhoramento da estrada Huallanca – Caraz",
      p1_alt: "Túnel escavado na rocha na estrada Huallanca – Caraz",
      lbl_ubi: "Localização", lbl_sector: "Setor", lbl_tipo: "Tipologia", lbl_cliente: "Cliente", lbl_monto: "Valor",
      p1_ubi: "Áncash (Peru)", p1_sector: "Transportes", p1_tipo: "Estradas",
      ...
      hero_kicker: "EC Proyectos de Ingeniería",
      hero_title: "Uma nova etapa com mais de <span class='hl'>50 anos</span> de experiência",
      hero_sub: "Desde 2024, a ECPI dá continuidade à trajetória do <span class='hl-b'>Grupo Euroconsult</span> integrando duas das suas empresas mais emblemáticas.",
      ...
      s1_p3: "Em 2024 começa uma nova etapa. A aquisição de duas das empresas mais emblemáticas da Euroconsult permite preservar e potenciar esse conhecimento dentro de uma empresa renovada, criada com uma clara orientação para a inovação, a excelência técnica e o serviço ao cliente.",
      mis_t: "Missão",
      ...
      s3_p: "Cada sede mantém a sua identidade regional sob o respaldo comum da EC Proyectos de Ingeniería.",
      lbl_matriz: "Matriz", lbl_filial: "Filial", lbl_filial2: "Filial",
      ...
      // Textos de la nueva etapa (2024). Las versiones EN/FR/PT las generó
      // Claude a partir del español: conviene que las revise un traductor.
      sg_title: "Uma nova etapa numa trajetória de mais de 50 anos",
      sg_p1: "A EC Proyectos de Ingeniería inicia em 2024 uma nova etapa empresarial que dá continuidade à experiência, ao conhecimento e às capacidades desenvolvidas durante décadas pelo Grupo Euroconsult, empresa histórica da engenharia espanhola fundada em 1968.",
      sg_p2: "A ECPI integrou no seu projeto duas das empresas mais emblemáticas da Euroconsult, preservando a sua atividade, as suas equipas profissionais e o seu conhecimento técnico. Sobre esta base sólida, construímos uma organização mais ágil, eficiente e preparada para enfrentar os novos desafios da engenharia.",
      pp_title: "O nosso ponto de partida",
      pp1_t: "+50 anos de trajetória",
      pp1_p: "Uma experiência e um conhecimento técnico construídos ao longo de mais de cinco décadas de atividade no setor da engenharia.",
      pp2_t: "2 empresas emblemáticas",
      pp2_p: "Duas empresas de referência da Euroconsult integradas na ECPI para assegurar a continuidade da sua atividade, capacidades e experiência.",
      pp3_t: "Uma equipa especializada",
      pp3_p: "Profissionais com ampla experiência e um profundo conhecimento técnico nas respetivas áreas de atividade.",
      pp4_t: "Uma nova visão",
      pp4_p: "A experiência e a solidez de uma trajetória histórica, aliadas a uma organização moderna, flexível e orientada para o futuro.",
      hito4_t: "2024 — Nova etapa",
      hito4_p: "A aquisição de duas das empresas mais emblemáticas da Euroconsult dá origem à EC Proyectos de Ingeniería.",
  ...
  function apply(lang) {
    ...
    // Y su descripción con <body data-desc-key="...">; el index usa meta_desc.
    var dk = document.body ? document.body.getAttribute('data-desc-key') : null;
    var m = document.querySelector('meta[name="description"]');
    if (!m) { m = document.createElement('meta'); m.setAttribute('name', 'description'); document.head.appendChild(m); }
    m.setAttribute('content', (dk && d[dk]) ? d[dk] : d.meta_desc);
